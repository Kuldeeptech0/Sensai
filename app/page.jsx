  ...
  return ( 
    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px md:px-6">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px md:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            return(
                  <div key={index} className="flex flex-col items-center text-center justify-center space-y-4" >
...
<section className="w-full py-12 md:py-24 lg:py-32 bg-muted/50">
  ...
  <section className="w-full py-12 md:py-24 lg:py-32 bg-background">
        <div className="container mx-auto px md:px-6">
          ...
          <p className="text-muted-foreground" >
            Find answers to common question about our platform
          </p>
          </div>
      ...
      <div className="mx-auto py-24 gradient rounded-lg">
        <div className="flex flex-col items-center justify-center space-y-4 text center max-w-3xl mx-auto">
          ...
          <p className="mx-auto max-w-[600px] text-primary-foreground/80 md:text-xl text-center" >
            Join thounsands of professionals who are advancing their careers with AI-powerd guidance.
          </p>
